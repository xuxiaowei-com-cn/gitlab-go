...
// List 列出项目作业 https://docs.gitlab.cn/jh/api/jobs.html#%E5%88%97%E5%87%BA%E9%A1%B9%E7%9B%AE%E4%BD%9C%E4%B8%9A
func List() *cli.Command {
	return &cli.Command{
		...
		Action: func(context *cli.Context) error {
			...
			err = ListProjectJobsPrintln(gitClient, id, scope, page, perPage, printJson, printTime, recursion)
			if err != nil {
				return err
			}
...
func ListProjectJobsPrintln(gitClient *gitlab.Client, pid interface{}, scope []string, page int, perPage int, printJson bool, printTime bool, recursion bool) error {

	jobs, response, err := ListProjectJobs(gitClient, pid, scope, page, perPage)
	if err != nil {
		return err
	}
	...
	if recursion && len(jobs) > 0 {
		err := ListProjectJobsPrintln(gitClient, pid, scope, page+1, perPage, printJson, printTime, recursion)
		if err != nil {
			return err
		}
	}
